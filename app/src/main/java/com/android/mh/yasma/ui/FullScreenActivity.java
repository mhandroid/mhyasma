...
public class FullScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addLayout(R.layout.activity_full_screen);
        ...
        Picasso.with(this).load(url).fit().into((ImageView) mContentView, new Callback() {
            @Override
            ...
            public void onError() {
                findViewById(R.id.progress_circular).setVisibility(View.GONE);
                Utils.showToastMsg(FullScreenActivity.this, getString(R.string.went_wrong));
                finish();
            }
        });
